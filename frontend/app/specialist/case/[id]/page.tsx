...
import { SpecialistCaseDetail } from "@/components/specialist/SpecialistCaseDetail";
...
export default function SpecialistCasePage() {
      ...
      try {
        ...
        const message =
          loadError instanceof Error
            ? loadError.message
            : "Unable to load specialist case.";
    ...
    return (
      <section className="mx-auto max-w-6xl px-4 py-16">
        <div className="rounded-2xl border bg-white p-6 shadow-sm">
          <LoadingSpinner label="Loading specialist case..." />
        </div>
      </section>
    );
  }
      ...
      <section className="mx-auto max-w-3xl px-4 py-16">
        <div className="rounded-2xl border border-red-200 bg-red-50 p-6">
          <h1 className="text-2xl font-bold text-red-950">
            Could not load specialist case
          </h1>
  ...
  return (
    <section className="mx-auto max-w-6xl px-4 py-10">
      <SpecialistCaseDetail initialRecord={record} />
    </section>
  );
}